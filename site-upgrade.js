...
(function () {
  ...
  const css = `
    ...
    :root {
      ...
      --teal:      #8ea7b3;   /* sage — secondary accent                   */
      --teal-lt:   #F5F4F1;   /* warm light — light backgrounds            */
      --sage:      #8ea7b3;   /* sage — secondary accent, callouts         */
      --sage-lt:   #F5F4F1;   /* warm light — light sage variant           */
      --sage-mid:  #8ea7b3;   /* sage — mid-tone borders                   */
      ...
      --border:    #8ea7b3;   /* warm border — subtle dividers             */
    ...
    @media (max-width: 899px) {
      ...
      .nav-menu.open {
        display: flex !important;
        background: #FFFFFF !important;
        border-top: 1px solid #8ea7b3 !important;
        border-bottom: 1px solid #8ea7b3 !important;
      ...
      .nav-menu > a[aria-current="page"] {
        ...
        border-bottom-color: #8ea7b3 !important;
    ...
    .su-trust-badge {
      ...
      background: #FFFFFF !important;
      border: 1px solid #8ea7b3 !important;
    ...
    .su-intro-featured .featured-badge {
      ...
      background: #8ea7b3 !important;      /* steel indigo — label register, not heading register */
      color: #FFFFFF !important;
    ...
    .back-btn, .restart-btn {
      background: transparent !important;
      color: #8ea7b3 !important;
      border: 1.5px solid #8ea7b3 !important;
      font-family: 'DM Sans', system-ui, sans-serif !important;
      font-weight: 500 !important;
      border-radius: 7px !important;
    }
    .back-btn:hover, .restart-btn:hover {
      border-color: #8ea7b3 !important;
      color: #565246 !important;
    }
    ...
    .h-fact {
      border-right-color: #8ea7b3 !important;
    }
    .h-fact-label {
      color: #383228 !important;
    }
    ...
    /* Exception: teal-colored labels inside dark navy card containers
       become invisible (#8ea7b3 on #565246). Override to light accent. */
    ...
    [style*="background:#eaf5f3"] {
      background: #F5F4F1 !important;
      border-left-color: #8ea7b3 !important;
    }
    ...
    /* TOC links */
    .page-toc ol li a                  { color: #8ea7b3 !important; }
    ...
    .su-page-sidebar {
      ...
      border-right: 1px solid #8ea7b3 !important;
  ...
  if (siteHeader) {
    // Recolor helix SVG from original teal → steel indigo (#8ea7b3 = rgb 69,106,124)
